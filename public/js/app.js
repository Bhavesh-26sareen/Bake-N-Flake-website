...
function initAdmin(socket) {
  var admintablebody = document.querySelector('.admintablebody');
  var orders = [];
  var markup;
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('/admin/orders', {
    headers: {
      "X-Requested-With": "XMLHttpRequest" //this value is added because backend developer need this flag to distinguish ajax request from request, in order to do some different request handling; such as error handling;

    }
  }).then(function (res) {
    orders = res.data;
    markup = generatemarkup(orders);
    admintablebody.innerHTML = markup;
  })["catch"](function (err) {
    console.log(err);
  });
  ...
  socket.on('orderplaced', function (order) {
    ...
    admintablebody.innerHTML = generatemarkup(orders);
  });
}
...
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
 ...
 //axios is used for sending the json data to server here in our example we are sending cake object

 //noty library for alert messages
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var cake = JSON.parse(btn.dataset.cake); //to convert string into object

    updateCart(cake); //console.log(cake)
  });
});
...
var liitems = document.querySelectorAll('.line');
...
function update(order) {
  ...
  var flag = true;
  liitems.forEach(function (liitem) {
    var data = liitem.dataset.status;
...
__webpack_require__(/*! C:\Users\HP\Desktop\Project\Realtime-Cake\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\HP\Desktop\Project\Realtime-Cake\resources\scss\app.scss */"./resources/scss/app.scss");
